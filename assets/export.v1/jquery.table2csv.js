(function ($) {
    $.fn.table2CSV = function (options) {
        ...
        return this.each(function () {
            ...
            var $exportButton = '<a href="'+dataType+'" download="'+fileName+'" class="export"><button class="btn btn-warning">'+settings.buttonContent+'</button></a>';
    ...
    $.fn.table2CSV.defaults = {
        ...
        headings: false,                         // [Boolean], display table headings (th elements) in the first row, [default: true]
