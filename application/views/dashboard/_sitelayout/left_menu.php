...
<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
    <a href="<?php echo base_url(); ?>index.php/template/profile" class="btn btn-link">
        <i class="fa fa-user"></i> Profile
    </a>
	<a href="<?php echo base_url(); ?>index.php/template/logout" class="btn btn-link" >
...
if($subArray["url"]!="#"){
	echo '<a class="nav-link nav-dropdown-toggle" href="'.base_url().'index.php/ebill/'. $subArray['url'].'"><i class="fa fa-'. $subArray['icon'] .'"></i> '. $mainTitle .'</a>';
} else {
